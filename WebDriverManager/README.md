...
So far, WebDriverManager supports **Chrome**, **Microsoft Edge**, **Internet Explorer**, **Marionette**, **Opera**, **PhantomJS** or **Appium** as follows:
...
1. Target version can be specified in class constructor using parameter:
    ...
    ``new ChromeDriverManager("2.22").Init();``

    In this case manager try to download ChromeDriver binary with **2.22** version.
...
NOTE 2: Some driver manager doesn't support version or architecture managements.
